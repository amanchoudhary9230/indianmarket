  ...
  return (
    <div className="w-full rounded-none md:rounded-2xl">
      ...
      <p className="text-sm max-w-sm mt-2">
        Access Your Account to Discover and Connect with Products and
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <button
          className="bg-gradient-to-br relative group/btn from-black dark:from-zinc-900 dark:to-zinc-900 to-neutral-600 block dark:bg-zinc-800 w-full rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] text-white dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset]"
          type="submit"
        >
          Login &rarr;
          <BottomGradient />
